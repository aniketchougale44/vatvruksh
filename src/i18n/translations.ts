...
export const translations: Record<string, Dict> = {
  ...
  // Footer
  'footer.about': {
    en: 'Your trusted travel partner in Kolhapur since 2002. We provide well-maintained cars and experienced, uniformed drivers for safe, comfortable local and outstation journeys.',
    hi: '2002 से कोल्हापुर में आपका भरोसेमंद यात्रा साथी। हम स्थानीय और आउटस्टेशन यात्राओं के लिए सुरक्षित, आरामदायक सफर हेतु अच्छी तरह से बनाए रखी गई गाड़ियाँ और अनुभवी, यूनिफॉर्म पहने ड्राइवर उपलब्ध कराते हैं।',
    mr: '2002 पासून कोल्हापूरमधील तुमचा विश्वासार्ह प्रवास सोबती. आम्ही स्थानिक व आउटस्टेशन प्रवासासाठी सुरक्षित, आरामदायक अनुभवासाठी व्यवस्थित निगा राखलेल्या गाड्या आणि अनुभवी, गणवेशातील ड्रायव्हर पुरवतो.',
    kn: '2002 ರಿಂದ ಕೊಲ್ಹಾಪುರದಲ್ಲಿ ನಿಮ್ಮ ವಿಶ್ವಾಸಾರ್ಹ ಪ್ರಯಾಣ ಪಾಲುದಾರ. ಸ್ಥಳೀಯ ಮತ್ತು ಔಟ್‌ಸ್ಟೇಷನ್ ಪ್ರಯಾಣಗಳಿಗಾಗಿ ಸುರಕ್ಷಿತ, ಆರಾಮದಾಯಕ ಪ್ರಯಾಣಕ್ಕಾಗಿ ನಾವು ಚೆನ್ನಾಗಿ ನಿರ್ವಹಿಸಲಾದ ಕಾರುಗಳು ಮತ್ತು ಅನುಭವಿ, ಸಮವಸ್ತ್ರಧಾರಿ ಚಾಲಕರನ್ನು ಒದಗಿಸುತ್ತೇವೆ.',
  },
